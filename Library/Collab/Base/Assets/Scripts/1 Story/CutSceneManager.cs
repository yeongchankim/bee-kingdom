    ...
    public class CutSceneManager : MonoBehaviour
    {
        ...
        void Start()
        {
            if(SceneManager.GetActiveScene().name == "9 EndingScene")
            {
                ...
                if(check1 != "하아…. 나비와의 일이 잘 안 풀려서 남아있는 동료들한테만 맡겼는데 잘 되고 있는지 모르겠네." && check2 == "1")  Happy_Ending();
                else if(check1 != "하아…. 나비와의 일이 잘 안 풀려서 남아있는 동료들한테만 맡겼는데 잘 되고 있는지 모르겠네." && check2 == "0") Normal_Ending1();
                else if(check1 == "하아…. 나비와의 일이 잘 안 풀려서 남아있는 동료들한테만 맡겼는데 잘 되고 있는지 모르겠네." && check2 == "1") Normal_Ending2();
                else if(check1 == "하아…. 나비와의 일이 잘 안 풀려서 남아있는 동료들한테만 맡겼는데 잘 되고 있는지 모르겠네." && check2 == "0") Bad_Ending();
            }
            else    ScriptLoad();
            isFade = true;
