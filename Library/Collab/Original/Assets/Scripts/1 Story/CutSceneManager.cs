...
namespace Yeol
{
    ...
    public class CutSceneManager : MonoBehaviour
    {
        ...
        void Start()
        {
            if(SceneManager.GetActiveScene().name == "9 EndingScene")
            {
                string check1 = PlayerPrefs.GetString("ButterflyGame");
                string check2 = PlayerPrefs.GetString("Bazzard");

                if(check1 != "음~. 아름다운 내게 딱 어울리는 맛이야. 달지만 깊이 있는 이 맛은 고풍스럽기도 하지만, 화려하기도 하지." && check2 == "1")  Happy_Ending();
                else if(check1 != "음~. 아름다운 내게 딱 어울리는 맛이야. 달지만 깊이 있는 이 맛은 고풍스럽기도 하지만, 화려하기도 하지." && check2 == "0") Normal_Ending1();
                else if(check1 == "음~. 아름다운 내게 딱 어울리는 맛이야. 달지만 깊이 있는 이 맛은 고풍스럽기도 하지만, 화려하기도 하지." && check2 == "1") Normal_Ending2();
                else if(check1 == "음~. 아름다운 내게 딱 어울리는 맛이야. 달지만 깊이 있는 이 맛은 고풍스럽기도 하지만, 화려하기도 하지." && check2 == "0") Bad_Ending();
            }
            else    ScriptLoad();
            isFade = true;
